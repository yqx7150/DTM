...
from DTM.models import lr_scheduler as lr_scheduler
...
class DTMS2Model(SRModel):
    ...
    def __init__(self, opt):
        super(DTMS2Model, self).__init__(opt)
        if self.is_train:
    ...
    def nondist_validation(self, dataloader, current_iter, tb_logger, save_img):
        ...
        self.is_train = False
        super(DTMS2Model, self).nondist_validation(dataloader, current_iter, tb_logger, save_img)
        self.is_train = True
